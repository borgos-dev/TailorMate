  ...
  return (
    <div className="min-h-screen bg-[#faf7f2] text-[#1c1917] flex flex-col justify-between selection:bg-[#e8dcce] selection:text-[#1c1917]">
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6">
        <div className="bg-[#ffffff] w-full max-w-xl rounded-xl border border-[#ede5da] shadow-md p-6 sm:p-8 space-y-6 my-4">
          ...
          {stepError && (
            <div className="p-3.5 rounded-lg bg-[#fef2f2] border border-[#fee2e2] text-xs sm:text-sm font-semibold text-[#b91c1c]">
              {stepError}
            </div>
          )}
          ...
          {step === 1 && (
            <form onSubmit={handleStep1Submit} className="space-y-4 sm:space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full pl-11 pr-4 py-3 rounded-lg border border-[#ede5da] bg-[#faf7f2] focus:outline-none focus:border-[#c69b6d] text-sm sm:text-base font-medium text-[#1c1917]"
                  />
              ...
              <div className="pt-3">
                <button
                  type="submit"
                  className="w-full py-3 rounded-lg bg-[#c69b6d] hover:bg-[#8c6b47] text-white font-semibold text-sm sm:text-base shadow-sm transition-all flex items-center justify-center gap-2"
                >
            ...
            <form onSubmit={handleStep2Submit} className="space-y-4 sm:space-y-5">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-3 rounded-lg border border-[#ede5da] bg-[#faf7f2] text-sm sm:text-base font-medium text-[#1c1917]"
                >
              ...
              <div className="pt-3 flex flex-col xs:flex-row gap-3">
                <button
                  type="button"
                  onClick={() => setStep(1)}
                  className="px-6 py-3 rounded-lg border border-[#ede5da] text-[#57534e] hover:bg-[#faf7f2] font-semibold text-xs sm:text-sm transition-colors flex items-center justify-center gap-2 shrink-0"
                >
                ...
                <button
                  type="submit"
                  className="flex-1 py-3 px-6 rounded-lg bg-[#c69b6d] hover:bg-[#8c6b47] text-white font-semibold text-xs sm:text-sm shadow-sm transition-all flex items-center justify-center gap-2"
                >
