  ...
  return (
    <div className="min-h-screen bg-[#faf7f2] text-[#1c1917] flex flex-col justify-between selection:bg-[#e8dcce] selection:text-[#1c1917]">
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6">
        <div className="bg-[#ffffff] w-full max-w-lg rounded-xl border border-[#ede5da] shadow-md p-6 sm:p-8 space-y-6 sm:space-y-7 my-4">
          ...
          {error && (
            <div className="p-3.5 rounded-lg bg-[#fef2f2] border border-[#fee2e2] text-xs sm:text-sm font-medium text-[#b91c1c] flex items-center gap-2.5">
          ...
          <div className="border-t border-[#ede5da] pt-5 space-y-3 text-center">
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 gap-2.5">
              <button
                ...
                className="p-3 rounded-lg border border-[#ede5da] hover:border-[#c69b6d] bg-[#faf7f2] text-left transition-colors"
              >
